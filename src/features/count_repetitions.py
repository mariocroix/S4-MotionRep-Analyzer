...
# Better to look at the acceleration data to count reps
plot_df = bench_df
...
# find the mean diff between predicted reps and real reps
error = mean_absolute_error(rep_df["reps"], rep_df["reps_pred"]).round(2)

# a visualization for all of the exercices and categories 
